...
import { Entry, NightscoutAPI } from "./nightscout/interface";
...
let nightscoutClient: NightscoutAPI;
if (process.env.NIGHTSCOUT_API_V3 === "true") {
    nightscoutClient = new ClientV3();
} else {
    nightscoutClient = new ClientV1(
        process.env.NIGHTSCOUT_API_TOKEN as string,
        process.env.NIGHTSCOUT_URL as string,
        Boolean(process.env.NIGHTSCOUT_DISABLE_HTTPS),
